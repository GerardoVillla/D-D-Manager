...
public class ControlCreacionPersonaje implements ActionListener {
    ...
    public ControlCreacionPersonaje(StoreDao sd,CharacterDao cd, Creacion_Personaje creacionPersonaje) {
        ...
        this.creacionPersonaje.getAtras().addActionListener(this);
    }

    public void actionPerformed(ActionEvent e) {
    	if(e.getSource()==this.creacionPersonaje.getAtras()) {
        ...
        if (e.getSource() == this.creacionPersonaje.getFinalizar()) {
        	try {      
                ...
                if(name == null || name.isEmpty()) {
                	throw new StringNullException("Nombre vacio");
                }
        	...
        	System.out.println("Error 1: " + b.getMessage());
        	
        	}catch(Exception a) {
        	System.out.println("Error 2: " + a.getMessage());
